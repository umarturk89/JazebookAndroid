...
namespace WoWonder.Activities.SettingsPreferences {
    ...
    public class Report_Activity : AppCompatActivity {
        ...
        protected override void OnCreate (Bundle savedInstanceState) {
            try {
                ...
                // Set our view from the "Settings_Report_Layout" layout resource
                SetContentView (Resource.Layout.Settings_Report_Layout);
                ...
                ToolBar.Title = this.GetText(Resource.String.Lbl_Report_Problem);
