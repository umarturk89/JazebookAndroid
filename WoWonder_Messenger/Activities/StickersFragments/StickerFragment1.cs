...
{
    public class StickerFragment1 : Fragment
    {
        private View FirstTabPage;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            try
            {
                FirstTabPage = inflater.Inflate(Resource.Layout.StickerFragment1, container, false);
                StickerRecylerview = (RecyclerView) FirstTabPage.FindViewById(Resource.Id.stickerRecyler1);
                ...
                StickerAdapter = new StickerRecylerAdapter.Sticker_Adapter(Stickers.StickerList1);
