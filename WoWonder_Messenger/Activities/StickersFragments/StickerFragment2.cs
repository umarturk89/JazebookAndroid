...
namespace WoWonder.Activities.StickersFragments {
    public class StickerFragment2 : Fragment {
        private View SecoundTabPage;
        ...
        public override View OnCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            try {
                SecoundTabPage = inflater.Inflate (Resource.Layout.StickerFragment1, container, false);
                StickerRecylerview = (RecyclerView) SecoundTabPage.FindViewById (Resource.Id.stickerRecyler1);
                ...
                StickerAdapter = new StickerRecylerAdapter.Sticker_Adapter (Stickers.StickerList2);

                StickerRecylerview.SetAdapter (StickerAdapter);
                StickerAdapter.OnItemClick += StickerAdapterOnOnItemClick;

                return SecoundTabPage;
            } catch (Exception e) {
                Console.WriteLine (e);
                return null;
            }
