...
namespace WoWonder.Activities.StickersFragments {
    public class StickerFragment4 : Fragment {
        ...
        public override View OnCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            try {
                ...
                StickerAdapter = new StickerRecylerAdapter.Sticker_Adapter (Stickers.StickerList4);
        ...
        private void StickerAdapterOnOnItemClick (object sender, AdapterClickEvents adapterClickEvents) {
            try {
                ...
                if (IMethods.CheckConnectivity ()) {
                    MessageController.SendMessageTask(ChatWindow_Activity.Userid, unixTimestamp.ToString(), "", "", "", StcikerUrl, "sticker" + adapterClickEvents.Position).ConfigureAwait(false); MessageController.SendMessageTask(ChatWindow_Activity.Userid, unixTimestamp.ToString(), "", "", "", StcikerUrl).ConfigureAwait(false);
                } else {
